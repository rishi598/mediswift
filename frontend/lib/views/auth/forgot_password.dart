...
import 'package:mediswiftmobile/views/auth/otp_screen.dart';
...
class ForgotPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF7FDF8), // soft MediSwift greenish tint
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Subtitle
            Text(
              "Enter your email address or phone number to receive an OTP for resetting your password.",
