...
class _PatientDashboardState extends State<PatientDashboard> {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> systems = [
      ...
      {
        "icon": "assets/icons/ic_brain.png",
        "title": "Neurology",
        "subtitle": "Brain & Nerves",
        "color": Colors.deepPurpleAccent.shade100,
      },
      {
        "icon": "assets/icons/ic_ortho.png",
        "title": "Orthopedics",
      ...
      {
        "icon": "assets/icons/ic_lungs.png",
        "title": "Pulmonology",
        "subtitle": "Lungs & Breathing",
        "color": Colors.greenAccent.shade100,
      },
      {
        "icon": "assets/icons/ic_skin.png",
        "title": "Dermatology",
        "subtitle": "Skin & Hair",
        "color": Colors.pinkAccent.shade100,
      },
      {
        "icon": "assets/icons/ic_stomach.png",
        "title": "Gastroenterology",
        "subtitle": "Stomach & Digestion",
        "color": Colors.amberAccent.shade100,
      },
      {
        "icon": "assets/icons/ic_toddler.png",
        "title": "Pediatrics",
        "subtitle": "Children’s Health",
        "color": Colors.indigoAccent.shade100,
      },
      {
        "icon": "assets/icons/ic_GM.png",
